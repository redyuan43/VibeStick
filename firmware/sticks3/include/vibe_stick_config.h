...
#define VIBE_STICK_FIRMWARE_VERSION_STICKC_PLUS_MINIJOY_BT "0.1.21"
...
#elif defined(VIBE_BOARD_MINIJOYC_BT)
#define FIRMWARE_VERSION VIBE_STICK_FIRMWARE_VERSION_STICKC_PLUS_MINIJOY_BT
#else
