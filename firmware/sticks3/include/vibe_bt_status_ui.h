...
typedef enum {
    ...
    VIBE_BT_UI_NO_BOND,
    VIBE_BT_UI_HID_FAILED,
    VIBE_BT_UI_HFP_FAILED,
    VIBE_BT_UI_PROFILES_FAILED,
    VIBE_BT_UI_AUDIO_FAILED,
    VIBE_BT_UI_OTA_CONNECTING,
    VIBE_BT_UI_OTA_CHECKING,
    VIBE_BT_UI_OTA_DOWNLOADING,
    VIBE_BT_UI_OTA_CURRENT,
    VIBE_BT_UI_OTA_FAILED,
    VIBE_BT_UI_ERROR,
} vibe_bt_ui_status_t;
