...
/*
 * BMI270 configuration blob from M5Unified src/utility/imu/BMI270_config.inl.
 * Copyright (c) M5Stack. Licensed under the MIT license.
 */


static const uint8_t s_bmi270_config_file[] = {
